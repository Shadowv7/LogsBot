...
module.exports = class {
  ...
  async run(member) {
    ...
    const image = new Canvas.Welcome()
      ...
      .setText("title", language.get("guildMemberAdd_TITLE"))
      .setText("message", language.get("guildMemberAdd_MESSAGE"))
      .setText("memberCount", language.get("guildMemberAdd_NUMBER"))
